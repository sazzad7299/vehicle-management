<template>
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="d-flex justify-content-center border border-success" v-if="purchases.length > 0">
                    ...
                    <div class="card-body">
                        <table class="table table-stripe">
                            ...
                            <tbody class="datalist">
                                <tr :class="index % 2 === 0 ? 'odd' : 'even'" v-for="(sale, index) in purchases">
...
export default {
    ...
    computed: {
        totalQuantitySum() {
            ...
            return this.purchases.reduce((sum, purchase) => sum + purchase.total_quantity, 0);
        },
        totalSum() {
