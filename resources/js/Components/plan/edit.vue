        ...
        <div class="row justify-content-md-center">
            <div class="col-md-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form @submit.prevent="updatePlan" @keydown="allErrors.clear($event.target.name)">
                            <div class="row">
...
export default defineComponent({
    ...
    methods: {
        getPlan() {
            axios.get(`plan/${this.$route.params.id}/edit`)
                .then(response => {
                    this.plan = response.data.result;
                    if(this.plan.image){
                        this.plan.image ='/'+this.plan.image;
                    }
        ...
        updatePlan() {
            this.loader(true);
            axios.put(`plan/${this.$route.params.id}`, {
                ...this.plan
            })
                .then(response => {
