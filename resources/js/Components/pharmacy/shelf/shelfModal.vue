        ...
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel2">{{ mode === 'add' ? 'Add Shelf' : 'Edit Shelf' }}</h5>
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                ...
                                <input type="text" v-model="unit.name" required class="form-control"
                                    placeholder="Shelf Name" name="name" />
    ...
    methods: {
        handleSubmit() {
            if (this.mode === 'add') {
                ...
                axios
                    .put(`shelf/${this.unit.id}`, { ...this.unit })
                    .then((response) => {
                        this.loader(false);
                        handleSuccessResponse.call(this, response);
                        this.$emit('unitAdded');
