<template>
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4">
            <span class="text-muted fw-light">Cost /</span>Cost List
        </h4>
        <div class="card mb-4">
                            ...
                            <div class="d-flex align-items-center mb-2 pb-1">
                                <div class="avatar me-2">
                                    <span class="avatar-initial rounded bg-label-primary"><i
                                            class='bx bxs-badge-dollar'></i></span>
                                </div>
                                <h4 class="ms-1 mb-0">{{ method.current_balance }} TK</h4>
                            </div>
                                ...
                                <div class="dt-buttons btn-group flex-wrap">
                                    <button class="btn btn-secondary btn-primary" type="button" @click="openAddModal">
                                        <span>
                                            ...
                                            <span class="d-md-inline-block d-none">Add Cost</span>
                                        </span>
                                    </button>
                                </div>
                            </div>
...
import UnitModal from "./modal.vue";
    ...
    methods: {
        ...
        getUnit({ page = 1, perPage = this.perPage, filter = this.filter }) {
            ...
            axios
                ...
                .then((response) => {
                    this.loader(false);
                    this.units = response.data.result.cost;
