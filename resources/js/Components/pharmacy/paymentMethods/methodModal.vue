            ...
            <div class="modal-content">
                ...
                <form @submit.prevent="handleSubmit" @keydown="allErrors.clear($event.target.name)">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col mb-3">
                                <label for="nameSmall" class="form-label">Method Name</label>
                        ...
                        <div class="row g-2">
                            <div class="col-8 mb-0">
                                <label class="form-label" for="emailSmall">Account Details</label>
                                <input type="text" class="form-control" id="emailSmall" placeholder="Methods Info"
...
export default {
    ...
    methods: {
        handleSubmit() {
            if (this.mode === 'add') {
                this.loader(true);
                axios.post('payment-method', { ...this.unit })
                    .then(response => {
                        this.loader(false);
                ...
                axios
                    .put(`payment-method/${this.unit.id}`, { ...this.unit })
                    .then((response) => {
                        this.loader(false);
                        handleSuccessResponse.call(this, response);
                        this.$emit('typeAdded');
