        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">{{ mode === 'add' ? 'Cash In/Out' : 'Edit Cash In/Out' }}
                    </h5>
                    ...
                    <div class="modal-body">
                        <div class="row g-2 mb-3">
                            <div class="col mb-0">
                                ...
                                <select name="type" v-model="unit.type" required class="form-control">
                                    <option value="1">Balance IN</option>
                                    <option value="2">Balance Out</option>
                                </select>
                                <span v-if="this.allErrors.has('type')" class="error text-danger fw-semibold mt-3"
                        ...
                        <div class="row g-2 mb-3">
                            ...
                            <div class="col mb-0">
                                <label class="form-label" for="emailSmall">Amount</label>
                        ...
                        <div class="row">
                            <div class="col mb-3">
                                <label for="nameSmall" class="form-label">Date</label>
...
export default {
    ...
    methods: {
        handleSubmit() {
            if (this.mode === 'add') {
                this.loader(true);
                axios.post('balance-info', { ...this.unit })
                    .then(response => {
                        this.loader(false);
                ...
                axios
                    .put(`balance-info/${this.unit.id}`, { ...this.unit })
                    .then((response) => {
                        this.loader(false);
                        handleSuccessResponse.call(this, response);
                        this.$emit('typeAdded');
        ...
        handleAmountExceedingBalance() {
            if (parseFloat(this.unit.amount) > parseFloat(this.unit.current_balance)) {
                toastr.warning('Withdraw Amount not getter then Current Balance');
