<template>
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Purchase  /</span>Purchase List</h4>
        <div class="card">
                ...
                <div class="dataTables_wrapper dt-bootstrap5 no-footer">
                    <div class="row ms-2 me-3">
                        <div
                            ...
                            <div
                                class="dt-action-buttons text-xl-end text-lg-start text-md-end text-start mt-md-0 mt-3" v-if="hasPermission('purchase.create')">
                                <div class="dt-buttons btn-group flex-wrap">
                                    <router-link :to="{ name: 'purchase.create'}">
                                        <button class="btn btn-secondary btn-primary" type="button">
                                            ...
                                            <span class="d-md-inline-block d-none">New Purchase</span>
                                            </span>
                                        </button>
                                    </router-link>
                                </div>
                    ...
                    <table class="invoice-list-table table border-top dataTable no-footer dtr-column">
                        ...
                        <tr>
                            ...
                            <!-- <th>Invoice Dis.</th> -->
                            <th>Total</th>
                            <th v-if="hasPermission('purchase.view') || hasPermission('purchase.delete')">Action</th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr :class="index % 2 === 0 ? 'odd' : 'even'" v-for="(purchase, index) in purchases.data">
                            ...
                            <td class="d-flex py-2px-2" v-if="hasPermission('purchase.view') || hasPermission('purchase.delete')">
                                <div class="mx-2" v-if="hasPermission('purchase.view')">
                                ...
                                <div v-if="hasPermission('purchase.delete')">
