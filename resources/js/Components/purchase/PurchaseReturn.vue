<template>
    <div class="modal fade" id="purchasereturnModal" tabindex="-1" aria-labelledby="paymentCollectionModalLabel"
        aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <form @submit.prevent="handlePayment" @keydown="allErrors.clear($event.target.name)">
                    <div class="modal-body">
                        ...
                        <div class="border border-warning mt-4 p-2">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" v-model="returnAmount" name="returnAmount" disabled/>
                            </div>
                        </div>
                    </div>
...
export default {
    ...
    methods: {
        ...
        axios.post("purchase-return", data)
        .then((response) => {
          this.loader(false);
    ...
    computed: {
        updatedAmount() {
            ...
            if(this.returnQuantity > this.Instock){
                ...
                toastr.warning(`Available stock ${this.Instock}`);
            };
