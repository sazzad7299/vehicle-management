<template lang="">
    <div>
        <section
                ...
                <section style="font-size: 12px;  line-height: 1.222;">
                    <table style="width: 100%;">
                        ...
                        <tr style="border-top: 1px solid #000; border-bottom: 1px solid #000;">
                            ...
                            <td style="font-size:12px">{{ purchaseData.result.invoice }}</td>
                        </tr>

                        <tr style="border-top: 1px solid #000; border-bottom: 1px solid #000;">
                            <td class="w-30" style="font-size:12px"><b>Customer Name:</b></td>
                            <td style="font-size:12px">{{ purchaseData.result.supplier.name }}</td>
                        </tr>
                    </table>
                </section>
                ...
                <section style="line-height: 1.23;">
                    <table style="width: 100%">
                        ...
                        <tbody>
                            ...
                            <tr style="border-top: 1px solid #000; border-bottom: 1px solid #000;" v-for="(product, index) in purchaseData.result.purchase_details" :key="index">
                ...
                <!-- <section style="line-height: 1.23;" v-if="purchaseData.result.sale_exchange.length >0">
                    ...
                    <table style="width: 100%">
                        ...
                        <tbody>
                            <tr style="border-top: 1px solid #000; border-bottom: 1px solid #000;" v-for="(product, index) in purchaseData.result.sale_exchange" :key="index">
                                <td class="text-center" style="vertical-align: top; font-size: 12px; text-align: center">{{ index + 1 }}
                                </td>
                                <td style="vertical-align: top; font-size: 12px">{{ product.medicine.name }}</td>
                                <td class="text-center" style="vertical-align: top; font-size: 12px; text-align: center">{{ product.quantity }}</td>
                ...
                <section style="line-height: 1.23;" v-if="purchaseData.result.purchase_returns.length>0">
                    -----------------------------------------------------
                    ...
                    <table style="width: 100%">
                        ...
                        <tbody>
                            ...
                            <tr style="border-top: 1px solid #000; border-bottom: 1px solid #000;" v-for="(product, index) in purchaseData.result.purchase_returns" :key="index">
                                <td class="text-center" style="vertical-align: top; font-size: 12px; text-align: center">{{ index + 1 }}
                                </td>
                                <td style="vertical-align: top; font-size: 12px">{{ product.medicine.name }}</td>
                                <td class="text-center" style="vertical-align: top; font-size: 12px; text-align: center">{{ product.quantity }}</td>
                ...
                <section style="line-height: 1.23; font-size: 12px; border-top: 1px solid #000;">
                    <table style="width: 100%">
                        <tr style=" border-top: 1px solid #000; border-bottom: 1px solid #000;">
                            ...
                            <td style="text-align: right; font-size: 12px; width: 70%">{{ purchaseData.result.subtotal? purchaseData.result.subtotal:0 }}</td>
                        </tr>
                        <tr style=" border-top: 1px solid #000; border-bottom: 1px solid #000;" v-if="purchaseData.result.returnable_price > 0">
                            <td style="text-align: right; font-size: 12px; width: 70%">Return Price:</td>
                            <td style="text-align: right; font-size: 12px; width: 70%">{{ purchaseData.result.returnable_price? purchaseData.result.returnable_price:0 }}</td>
                        </tr>
                        <tr style=" border-top: 1px solid #000; border-bottom: 1px solid #000;">
                            <td style="text-align: right; font-size: 12px; width: 70%">Discount:</td>
                            <td style="text-align: right; font-size: 12px; width: 70%">{{ purchaseData.result.medicine_discount?purchaseData.result.medicine_discount:0 }}</td>
                        </tr>
                        <tr style=" border-top: 1px solid #000; border-bottom: 1px solid #000;">
                        ...
                        <tr style=" border-top: 1px solid #000; border-bottom: 1px solid #000;">
                            ...
                            <td style="text-align: right; font-size: 12px; width: 70%">{{ purchaseData.result.total  - purchaseData.result.returnable_price}}</td>
                        </tr>
                        <tr style=" border-top: 1px solid #000; border-bottom: 1px solid #000;">
                ...
                <section style="line-height: 1.222; font-size: 12px; font-style: italic; padding: 0px 0">
                    <span style="line-height: 1.222; font-size: 12px; font-style: italic; text-transform:capitalize"><b>In Text:</b> {{ purchaseData.result.numberTotext }} TK Only</span><br>
                </section>
                -----------------------------------------------------
                <section style="line-height: 1.222;">
                    ...
                    <table style="width: 100%">
                        <tr>
                            ...
                            <td style="font-size: 12px;text-align: right;">{{ purchaseData.result.total_paid?purchaseData.result.total_paid : 0 }}</td>
                        </tr>
                        <tr>
                            <td style="font-size: 12px;">-RETURNED AMOUNT</td>
                            <td style="font-size: 12px;text-align: right;">{{ purchaseData.result.return_price}}</td>
                        </tr>
                    </table>
                </section>
                -----------------------------------------------------
...
export default {
    ...
    computed: {
        totalDue() {
            const total = this.purchaseData.result.total;
            const totalPaid = this.purchaseData.result.total_paid;
            const returnable_price = this.purchaseData.result.returnable_price;
            const return_price = this.purchaseData.result.return_price;
